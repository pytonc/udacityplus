...
from web_temp.models.Details import CourseAttempt
from web_temp.models.Course import  Source
from web_temp.tests.testdata import *
from web_temp.models import Course, User
