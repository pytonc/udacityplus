...
config = {
    ...
    # webapp2 sessions
    'webapp2_extras.sessions' : {'secret_key': 'C2wuhu6abubRuphaDuwAneruswupU5adeth$qutrayedraQekeVUjujArAyUthAq'},
    ...
    'locales' : ['en_US', 'es_ES', 'it_IT', 'zh_CN', 'id_ID', 'fr_FR', 'de_DE', 'ru_RU', 'pt_BR'],
